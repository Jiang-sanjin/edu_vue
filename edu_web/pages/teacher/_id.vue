        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img style="max-width:270px; max-height:270px" :src="teacher.avatar">
            </section>
            <h3 class="hLh30">
              <span class="fsize24 c-333">
                {{teacher.name}}&nbsp;&nbsp;&nbsp;{{teacher.teacherLevel.name}}
              </span>
            </h3>
            <section class="mt10">
...
export default {
  asyncData({ params, error }) {
    ...
    return teacherApi.getTeacherInfo(params.id).then(res => {
      // console.log("shuju1   "+ res.data.teacher.teacherLevel.name)
      return {

    ...
    <el-form label-width="120px">
      <el-form-item label="信息描述">
        ...
        <el-tag>
          ...
          <a :href="OSS_PATH + '/%E8%AF%BE%E7%A8%8B%E5%88%86%E7%B1%BB.xls'">点击下载模版</a>
        </el-tag>

      </el-form-item>

      <el-form-item label="选择Excel">
        <!-- :disabled="importBtnDisabled"  点击后不可再用 -->
        <el-upload ref="upload" :auto-upload="false" :on-success="fileUploadSuccess" :on-error="fileUploadError"
          :disabled="importBtnDisabled" :limit="1" :action="BASE_API+'/subject/import'" name="file"
...
export default {
  data() {
    return {
      ...
      importBtnDisabled: false, // 按钮是否禁用,  false为不禁用   true为禁用
      loading: false
    };
  },
  created() {},

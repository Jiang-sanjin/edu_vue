<template>
  <div class="app-container">
    ...
    <el-form-item label="课程类别">
        <el-select
        v-model="searchObj.subject_parent_id"
        placeholder="请选择"
        ...
        <!-- 二级分类 -->
        <el-select v-model="searchObj.subject_id" placeholder="请选择">
        <el-option
    ...
    <el-table-column label="发布时间" align="center">
        <template slot-scope="scope">
        {{ scope.row.gmt_modified.substr(0, 10) }}
        </template>
    </el-table-column>
